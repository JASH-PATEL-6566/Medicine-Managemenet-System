...
const AddItem = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(process.env.DB + `/Medicine/${checked ? 'whole_remove' : 'partial_remove'}`, (checked ? { uid: auth.currentUser.uid, ...value, } : { uid: auth.currentUser.uid, ...value, remove_quantity: quantity }))
            .then((res) => {
